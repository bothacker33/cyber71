...
def method():
    ...
    'viewport-width': '980',
            ...
            response = r.post('https://m.facebook.com/?stype=lo&deoia=1&jlou=Afdbg-_r8FRwy22CXV2J_2OplWZMAGHjYliqSOH4VXfrufjXfrkrAhag7DOlLrgh6MSRZfiIbEs_gKQ_KHfEE-bZ0dbX_Sy5Sldi6Jvq22FDJw&smuh=26497&lh=Ac8iDlQ70hm3rjZTrtc',data=data,headers=header,allow_redirects=False)
      #      print(response.text) 
